<div class="box has-text-centered columns m-5">
  <a href="/#/addtrail" class="column is-2">
    <i class="fas fa-plus fa-3x" style="color:rgb(153, 196, 74)"></i>
  </a>
  ...
  <a href="/#/weather" class="column is-2">
    <i class="fas fa-cloud-sun-rain fa-3x"  style="color:rgb(150, 93, 176)"></i>
  </a>
